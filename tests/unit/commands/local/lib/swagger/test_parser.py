...
class TestSwaggerParser_get_apis(TestCase):
    ...
    def test_with_one_path_method(self):
        ...
        expected = [Api(path="/path1", method="get", function_name=function_name)]
    ...
    def test_with_combination_of_paths_methods(self):
        ...
        expected = {
            Api(path="/path1", method="get", function_name=function_name),
            Api(path="/path1", method="delete", function_name=function_name),
            Api(path="/path2", method="post", function_name=function_name),
        }
        result = parser.get_apis()
    ...
    def test_with_any_method(self):
        ...
        expected = [Api(path="/path1", method="ANY", function_name=function_name)]
        result = parser.get_apis()
...
class TestSwaggerParser_get_binary_media_types(TestCase):
    ...
    @parameterized.expand([
        ...
        param("Swagger define binary media types",
